...
// eg: `data-parsley-stop-on-first-failing-constraint="false"`
    ...
    var ParsleyDefaults = {
        ...
        excluded: 'input[type=button], input[type=submit], input[type=reset], input[type=hidden], input[class=hidden]',
    ...
    ParsleyUI.prototype = {
        ...
        focus: function (formInstance) {
            ...
            var position = $(formInstance._focusedField).offset();
            $("html, body").scrollTop(position.top-80);
        ...
        manageFailingFieldTrigger: function (fieldInstance) {
            ...
            if (!new RegExp('focusout', 'i').test(fieldInstance.options.trigger || ''))
                return fieldInstance.$element.on('focusout.ParsleyFailedOnce', false, $.proxy(fieldInstance.validate, fieldInstance));
